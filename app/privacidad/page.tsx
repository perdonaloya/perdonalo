    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="mx-auto max-w-2xl px-6 py-12 space-y-8 text-sm text-foreground leading-relaxed">
        ...
        <section className="space-y-2">
          ...
          <p>Tienes derecho a acceder, rectificar o eliminar tus datos personales en cualquier momento. Para ejercer estos derechos <a href="https://wa.me/56962121964" className="underline underline-offset-4 hover:text-primary transition-colors">contáctanos por WhatsApp</a>.</p>
        </section>
